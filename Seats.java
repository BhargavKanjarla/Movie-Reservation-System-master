		...
		btnBook.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				Class.forName("com.mysql.jdbc.Driver");  
					Connection con=DriverManager.getConnection( "jdbc:mysql://localhost:3306/bhargav","root","bhagi123");  
...
//                  ps.setString(1, screen_no);
		...
		Class.forName("com.mysql.jdbc.Driver");  
					Connection con=DriverManager.getConnection( "jdbc:mysql://localhost:3306/bhargav","root","bhagi123"); 
		  PreparedStatement ps = con.prepareStatement("select seat_string from "+screen_no+" where tslot=?");
//		  ps.setString(1, screen_no);
